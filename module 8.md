...
4. Input  
   Read the number of strings n from the user  
   Dynamically allocate memory for each string in s  
5. Permutation Generation Loop  
6. Memory Deallocation  
   Free the memory allocated for each string in s  
...
## Algorithm:
1. Start  
2. Define function square() with no parameters  
3. Inside function:  
   - Get input  
   - Calculate square  
   - Return value  
